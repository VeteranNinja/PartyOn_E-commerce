...
public class NVPAPICaller
{
    ...
    public string APIUsername = "najeebhassan33-facilitator_api1.gmail.com";
    private string APIPassword = "NH5Y6ML2UR49HLUP";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AU.MTULl97dxgD43Lbh6POmLeQAw";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:55460/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:55460/Checkout/CheckoutCancel.aspx";
        ...
        using (PartyOn.Logic.ShoppingCartActions myCartOrders = new PartyOn.Logic.ShoppingCartActions())
        {
